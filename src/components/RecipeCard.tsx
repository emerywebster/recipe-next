...
const RecipeCard = ({
  ...
  return (
    <Card
      className="w-full h-[386px] bg-white cursor-pointer transform transition-all duration-150 hover:scale-[1.02] hover:shadow-lg"
      onClick={onClick}
    >
      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-center mb-3">
          ...
          <span className="text-sm text-gray-600">{cookCount} times cooked</span>
        </div>
      </CardContent>
